...
with col1:
    title_dropdown1 = st.selectbox('Title 1:', [''] + list(unique_titles), index='Weird Tales')
    search_box1 = st.text_input('Search Term for Title 1:')
    st.text(" ")  # Add empty space for better alignment

with col2:
    title_dropdown2 = st.selectbox('Title 2:', [''] + list(unique_titles), index='Amazing Stories')
